...
The value of $ϕ=0.3$ is relatively low, which means the influence of $X_{t−1}$ is moderate. The series will exhibit limited persistence; therefore, the deviations from the mean will fade quickly as the lagged influence diminishes over time.
